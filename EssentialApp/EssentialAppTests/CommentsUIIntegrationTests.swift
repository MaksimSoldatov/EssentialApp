//
//  Created by Maksim Soldatov on 2.01.21.
//  
import UIKit
import XCTest
import Combine
...
final class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsActions_requestCommentsFromLoader() {
        ...
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadCommentsCallCount, 2, "Expected yet another loading request once user initiates another reload")
